...
enum AlertFilter { all, critical, warning, normal, active, resolved }
...
final class AlertsLoaded extends AlertsState {
  const AlertsLoaded({required this.alerts, super.filter});
...
final class AlertsError extends AlertsState {
  const AlertsError({required this.message, super.filter});
